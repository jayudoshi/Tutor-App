    ...
    return (
        ...
        <div className="row">
            <ul class="nav flex-column" style={{padding:"5px 15px 5px 30px"}}>
                    ...
                    <li className={props.view === "Tutors" ? "nav-item sidebar-link m-2 p-2 sidebar-link-acitve" : "nav-item sidebar-link m-2 p-2"} 
                        onClick={() => {handleToggle() ; props.setView("Tutors") ; localStorage.setItem('view' , 'Tutors')}}
                    >
